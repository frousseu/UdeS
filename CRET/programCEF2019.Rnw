...
\rowcolor{headercol}
\multirow{1}{*} & \multicolumn{1}{!{\color{white}\vline}c}{\textbf{\color{titlecol}Reconstitution climatique} \itshape{\color{titlecol}P1-4250}} & \multicolumn{1}{!{\color{white}\vline}c}{\textbf{\color{titlecol}Sols forestiers} \itshape{\color{titlecol}P1-4270}} & \multicolumn{1}{!{\color{white}\vline}c}{\textbf{\footnotesize\color{titlecol}Gel et Perturbations forestières II} \itshape{\color{titlecol}P1-4280}} \\
 \rowcolor{headercol}
