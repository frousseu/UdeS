...
\rowcolor{breakcol}
\multicolumn{1}{c}{\color{white}15:10} &
...
\multicolumn{3}{!{\color{white}\vline}c}{\color{white}\textbf{Activité sociale - Soirée à La Pulperie de Chicoutimi - Pulperie de Chicoutimi}} \\ 
\end{tabular} 
