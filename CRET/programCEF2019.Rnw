...
\multicolumn{3}{c}{\parbox{18cm}{\vspace{0.5em}Mot de bienvenue, \textbf{Pierre Drapeau} et \textbf{Louis Bernier}, direction du CEF \hfill \itshape{Amphithéâtre P0-5000}\vspace{0.5em}}} \\
...
\rowcolor{breakcol}
\multicolumn{1}{c}{\color{white}10:00} &
...
\rowcolor{breakcol}
\multicolumn{1}{c}{\color{white}11:50} &
\multicolumn{3}{!{\color{white}\vline}c}{\color{white}\textbf{Dîner} \itshape{Cafétéria - centre social} -- \textbf{AGA des membres} \itshape{P0-7000}} \\
\arrayrulecolor{white}
\hline
\hline
\arrayrulecolor{hrulecol}
...
\rowcolor{headercol}
\multirow{1}{*} & \multicolumn{1}{!{\color{white}\vline}c}{\textbf{\color{titlecol}Agroforesterie} \itshape{\color{titlecol}P1-4250}} & \multicolumn{1}{!{\color{white}\vline}c}{\textbf{\color{titlecol}Télédétection} \itshape{\color{titlecol}P1-4270}} & \multicolumn{1}{!{\color{white}\vline}c}{\textbf{\color{titlecol}Faune} \itshape{\color{titlecol}P1-4280}} \\
 \rowcolor{headercol}
\multirow{1}{*} & \multicolumn{1}{!{\color{white}\vline}c}{\color{breakcol}\scriptsize\textit{Modéré par Jérôme Laganière}} & \multicolumn{1}{!{\color{white}\vline}c}{\color{breakcol}\scriptsize\textit{Modéré par François Girard}}  & \multicolumn{1}{!{\color{white}\vline}c}{\color{breakcol}\scriptsize\textit{Modéré par Louis Imbeau}}\\
 \rowcolor{headercol}
\multirow{1}{*} & \multicolumn{1}{!{\color{white}\vline}c}{\color{breakcol}\scriptsize\textit{Tech. A.-V. Nada Aloui}} & \multicolumn{1}{!{\color{white}\vline}c}{\color{breakcol}\scriptsize\textit{Tech. A.-V. Patricia Girardin}}  & \multicolumn{1}{!{\color{white}\vline}c}{\color{breakcol}\scriptsize\textit{Tech. A.-V. Membres}}\\
\rowcolor{white}
...
\rowcolor{breakcol}
\multicolumn{1}{c}{\color{white}15:00} &
...
\rowcolor{headercol}
\multirow{1}{*} & \multicolumn{1}{!{\color{white}\vline}c}{\textbf{\color{titlecol}Historique des perturbations} \itshape{\color{titlecol}P1-4250}} & \multicolumn{1}{!{\color{white}\vline}c}{\textbf{\color{titlecol}Traits fonctionnels} \itshape{\color{titlecol}P1-4270}} & \multicolumn{1}{!{\color{white}\vline}c}{\textbf{\color{titlecol}Une question de gradient} \itshape{\color{titlecol}P1-4280}} \\
 \rowcolor{headercol}
\multirow{1}{*} & \multicolumn{1}{!{\color{white}\vline}c}{\color{breakcol}\scriptsize\textit{Modéré par Miguel Montoro Girona}} & \multicolumn{1}{!{\color{white}\vline}c}{\color{breakcol}\scriptsize\textit{Modéré par Alain Paquette}}  & \multicolumn{1}{!{\color{white}\vline}c}{\color{breakcol}\scriptsize\textit{Modéré par Emilie Champagne}}\\
 \rowcolor{headercol}
\multirow{1}{*} & \multicolumn{1}{!{\color{white}\vline}c}{\color{breakcol}\scriptsize\textit{Tech. A.-V. Marine Duperat}} & \multicolumn{1}{!{\color{white}\vline}c}{\color{breakcol}\scriptsize\textit{Tech. A.-V. Marion Noualhaguet}}  & \multicolumn{1}{!{\color{white}\vline}c}{\color{breakcol}\scriptsize\textit{Tech. A.-V. Nada Aloui}}\\
\rowcolor{white}
...
\rowcolor{breakcol}
\multicolumn{1}{c}{\color{white}18:00} &
\multicolumn{3}{!{\color{white}\vline}c}{\color{white}\textbf{Activité sociale - Soirée à La Pulperie de Chicoutimi} - \textit{Pulperie de Chicoutimi}} \\ 
\end{tabular} 
...
\begin{figure}[h]
\noindent\scalebox{1.25}{\includegraphics[trim={0cm 0cm 0cm 0cm},clip]{footerCEF2019}}
\centering
\end{figure}
...
%\pagebreak
%\begin{figure}[h]
%\noindent\scalebox{1.25}{\includegraphics[trim={0cm 0cm 0cm 0cm},clip]{headerCEF2019}}
%\centering
%\end{figure}
%\vspace{-1em}
...
\rowcolor{headercol}
\multirow{1}{*} & \multicolumn{1}{!{\color{white}\vline}c}{\textbf{\color{titlecol}Perturbations forestières I} \itshape{\color{titlecol}P1-4250}} & \multicolumn{1}{!{\color{white}\vline}c}{\textbf{\color{titlecol}Sylviculture} \itshape{\color{titlecol}P1-4270}} & \multicolumn{1}{!{\color{white}\vline}c}{\textbf{\color{titlecol}Une question de sécheresse} \itshape{\color{titlecol}P1-4280}} \\
 \rowcolor{headercol}
\multirow{1}{*} & \multicolumn{1}{!{\color{white}\vline}c}{\color{breakcol}\scriptsize\textit{Modéré par Miguel Xavier Cavard}} & \multicolumn{1}{!{\color{white}\vline}c}{\color{breakcol}\scriptsize\textit{Modéré par Nicole Fenton}}  & \multicolumn{1}{!{\color{white}\vline}c}{\color{breakcol}\scriptsize\textit{Modéré par Sylvain Delagrange}}\\
 \rowcolor{headercol}
\multirow{1}{*} & \multicolumn{1}{!{\color{white}\vline}c}{\color{breakcol}\scriptsize\textit{Tech. A.-V. Ange-Marie Botroh}} & \multicolumn{1}{!{\color{white}\vline}c}{\color{breakcol}\scriptsize\textit{Tech. A.-V. Élise Bouchard}}  & \multicolumn{1}{!{\color{white}\vline}c}{\color{breakcol}\scriptsize\textit{Tech. A.-V. Geneviève Gagné}}\\
\rowcolor{white}


\multirow{1}{*}{08:30} & 
Évaluation de quelques paramètres de la qualité du bois affecté par l’épidémie de la tordeuse des bourgeons de l’épinette \newline\hspace*{\fill} \hfill  \textbf{Carlos Paixao} & Release of heritage oaks by gap-cutting: effects on oak vitality, insects and plants \newline\newline\hspace*{\fill} \hfill  \textbf{Delphine Lariviere} & Influence de la compétition arborescente sur la vulnérabilité à la sécheresse du sapin baumier en forêt boréale \newline\hspace*{\fill} \hfill  \textbf{Alexandra Villiard} \\
%\arrayrulecolor{hrulecol}\hline 
\multirow{1}{*}{08:50} & 
Nouveaux traitements sylvicoles pour réussir l’aménagement durable de la forêt boréale \newline\hspace*{\fill} \hfill  \newline\hphantom{***************}\textbf{Miguel Montoro Girona} & Fourteen-year impacts of partial and clear cut forest harvest on epixylic bryophyte species in the boreal black spruce –feathermoss forests. \hspace*{5mm}\textbf{Jeffrey Opoku-Nyame} & Influence des stress climatiques et biotiques sur les processus de mortalité de l'épinette noire dans la forêt boréale du Québec \hspace*{\fill} \hfill  \textbf{Chantal Moulin Vézina} \\
%\arrayrulecolor{hrulecol}\hline 
\multirow{1}{*}{09:10} & 
Croissance primaire et secondaire des branches de l'épinette noire et du sapin baumier après une coupe avec protection des petites tiges marchandes (CPPTM) \newline\hspace*{\fill} \hfill  \textbf{Audrey Lemay} & Traitements sylvicoles: solution prometteuse pour la remise en production des forêts paludifiées \newline\newline\hspace*{\fill} \hfill  \textbf{Mohammed Henneb} & Growth rate rather than growing season length determines wood biomass in dry environments \newline\newline\hspace*{\fill} \hfill  \textbf{Ping Ren} \\
%\arrayrulecolor{hrulecol}\hline 
\multirow{1}{*}{09:30} & 
Minimiser les risques de chablis en sapinière: adaptation du modèle britannique ForestGALES pour la forêt boréale \newline\newline\hspace*{\fill} \hfill  \textbf{Marine Duperat} & Contribution relative des arbres à la croissance de peuplements en fonction de leur structure et de traitements sylvicoles \newline\newline\hspace*{\fill} \hfill  \textbf{Caroline Lemire} & Dynamique sous-terraine et vulnérabilité à la sécheresse: comment la position microtopographique et l’exclusion des précipitations influencent-elles la production en racines fines en forêt tempérée ? \hspace*{\fill} \hfill  \textbf{Florence Tauc} \\
%\arrayrulecolor{hrulecol}\hline 
...
\rowcolor{headercol}
\multirow{1}{*} & \multicolumn{1}{!{\color{white}\vline}c}{\textbf{\color{titlecol}Reconstitution climatique} \itshape{\color{titlecol}P1-4250}} & \multicolumn{1}{!{\color{white}\vline}c}{\textbf{\color{titlecol}Sols forestiers} \itshape{\color{titlecol}P1-4270}} & \multicolumn{1}{!{\color{white}\vline}c}{\textbf{\small\color{titlecol}Gel et Perturbations forestières II} \itshape{\color{titlecol}P1-4280}} \\
 \rowcolor{headercol}
\multirow{1}{*} & \multicolumn{1}{!{\color{white}\vline}c}{\color{breakcol}\scriptsize\textit{Modéré par Victor Danneyrolles}} & \multicolumn{1}{!{\color{white}\vline}c}{\color{breakcol}\scriptsize\textit{Modéré par Annie DesRochers}}  & \multicolumn{1}{!{\color{white}\vline}c}{\color{breakcol}\scriptsize\textit{Modéré par Guillaume de Lafontaine}}\\
 \rowcolor{headercol}
\multirow{1}{*} & \multicolumn{1}{!{\color{white}\vline}c}{\color{breakcol}\scriptsize\textit{Tech. A.-V. Membres}} & \multicolumn{1}{!{\color{white}\vline}c}{\color{breakcol}\scriptsize\textit{Tech. A.-V. Vanessa Audet-Giroux}}  & \multicolumn{1}{!{\color{white}\vline}c}{\color{breakcol}\scriptsize\textit{Tech. A.-V. Membres}}\\
\rowcolor{white}
...
\rowcolor{headercol}
\multirow{1}{*} & \multicolumn{1}{!{\color{white}\vline}c}{\textbf{\color{titlecol}Modélisation} \itshape{\color{titlecol}P1-4250}} & \multicolumn{1}{!{\color{white}\vline}c}{\textbf{\color{titlecol}Envahisseurs exotiques} \itshape{\color{titlecol}P1-4270}} & \multicolumn{1}{!{\color{white}\vline}c}{\textbf{\color{titlecol}Foresterie sociale} \itshape{\color{titlecol}P1-4280}} \\
\rowcolor{headercol}
\multirow{1}{*} & \multicolumn{1}{!{\color{white}\vline}c}{\color{breakcol}\scriptsize\textit{Modéré par Elise Filotas}} & \multicolumn{1}{!{\color{white}\vline}c}{\color{breakcol}\scriptsize\textit{Modéré par Evelyn Belien}}  & \multicolumn{1}{!{\color{white}\vline}c}{\color{breakcol}\scriptsize\textit{Modéré par Osvaldo Valeria}}\\
\rowcolor{headercol}
\multirow{1}{*} & \multicolumn{1}{!{\color{white}\vline}c}{\color{breakcol}\scriptsize\textit{Tech. A.-V. Maurane Bourgouin}} & \multicolumn{1}{!{\color{white}\vline}c}{\color{breakcol}\scriptsize\textit{Tech. A.-V. Myriam Pilliet}}  & \multicolumn{1}{!{\color{white}\vline}c}{\color{breakcol}\scriptsize\textit{Tech. A.-V. Françoise Cardou}}\\
\rowcolor{white}
...
\multicolumn{3}{c}{\parbox{18cm}{\vspace{0.5em}\centering\color{black}\textbf{COMMENT CONCILIER LES DIFFÉRENTES FONCTIONS DE LA FORÊT POUR LES PROCHAINES GÉNÉRATIONS ?}\newline\\\raggedright Animation: \textbf{Olivier Riffon}\\\raggedright Panélistes: \textbf{Alison Munson}, \textbf{Nicolas Meagher}, \textbf{Manuel Kak'wa Kurtness}, \textbf{Lorie Ouellet}, \textbf{Steeve Coulombe} \vspace{0.5em}}} \\
\arrayrulecolor{hrulecol}\hline
...
\end{tabular}
*\textit{Seuls les membres étudiants gradués sont évalués pour participer au concours de la meilleure affiche. Les autres sont identifiés par non-membre/non-étudiant (NE)}
...
\textbf{GitHub et R-INLA} \newline\textit{P1-5060} &	Introduction à GitHub et à la création de packages avec Rstudio\newline &	Introduction aux modèles spatiaux avec R-INLA \newline\newline\hspace*{\fill} \hfill  \textbf{François Rousseu}\\\hline

\textbf{Articles scientifiques} \newline\textit{P1-5070} &	Méta-analyses 101 \newline\newline\newline\hspace*{\fill} \hfill  \textbf{Emilie Champagne} &	Scientific writing - How to better read and write journal articles \newline\newline\hspace*{\fill} \hfill  \textbf{Emma Despland}\\\hline

\textbf{Méthodes participatives} \newline\textit{P1-5090} & Introduction et expérimentation des méthodes participatives pour la conciliation des usages et la gestion durable de la forêt \newline\newline\hspace*{\fill} \hfill  \textbf{Maria Isabel Canovas Abril} & \\\hline
