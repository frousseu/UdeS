...
\renewcommand{\arraystretch}{1.11} % General space between rows (1 standard) 
...
\renewcommand{\arraystretch}{1.21} % General space between rows (1 standard) 
...
05 &	\textbf{Jérôme Chapuis} &	Génomique fonctionnelle de la virulence et la fitness chez Ophiostoma novo-ulmi\\\hline
