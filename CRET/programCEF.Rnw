...
\multicolumn{2}{!{\color{white}\vline}c}{\color{white}\textbf{Dîner} \itshape{Espace Jardin} -- \textnormal{AGA des membres} \itshape{ADJ-2320}} \\
\arrayrulecolor{white}
\hline
\hline
\arrayrulecolor{palegray}
...
\multirow{1}{*} & \multicolumn{1}{!{\color{white}\vline}c}{\textbf{\color{y}FEUX DE FORÊT} \itshape{\color{y}ADJ-4512}} & \multicolumn{1}{!{\color{white}\vline}c}{\textbf{\color{y}HYDROLOGIE FORESTIÈRE I} \itshape{\scriptsize\color{y}ADJ-2320}} & \multicolumn{1}{!{\color{white}\vline}c}{\textbf{\color{y}ÉCOPHYSIOLOGIE} \itshape{\color{y}ADJ-2326}} \\
 \rowcolor{cefd}
\multirow{1}{*} & \multicolumn{1}{!{\color{white}\vline}c}{\color{y}\scriptsize\textit{Modéré par Pierre Drapeau}} & \multicolumn{1}{!{\color{white}\vline}c}{\color{y}\scriptsize\textit{Modéré par Membres}}  & \multicolumn{1}{!{\color{white}\vline}c}{\color{y}\scriptsize\textit{Modéré par Sylvain Delagrange}}\\
 \rowcolor{cefd}
...
\multirow{1}{*}{10:20} & 
Forêt boréale, bryophytes et résilience : le syndrome de la passoire et du dôme \newline\newline\newline\hspace*{\fill} \hfill  \textbf{Marion Barbé} & L’hydrologie une question de survie pour les épinettes noires de l’Abitibi! \newline\newline\newline\hspace*{\fill} \hfill  \textbf{Samuel Roy Proulx} & Modélisation à l’échelle du paysage de la vulnérabilité et du potentiel de croissance de l’érable à sucre à la sécheresse en fonction de sa réponse architecturale et écophysiologique au climat\hphantom{****}\textbf{Maxime D'Amours} \\
\arrayrulecolor{palegray}\hline 
\multirow{1}{*}{10:40} & 
...
\multirow{1}{*} & \multicolumn{1}{!{\color{white}\vline}c}{\color{y}\scriptsize\textit{Modéré par Robert Schneider}} & \multicolumn{1}{!{\color{white}\vline}c}{\color{y}\scriptsize\textit{Modéré par Alison Munson}}\\
 \rowcolor{cefd}
\multirow{1}{*} & \multicolumn{1}{!{\color{white}\vline}c}{\color{y}\scriptsize\textit{Tech. A.-V. Laurie Dupont-Leduc}} & \multicolumn{1}{!{\color{white}\vline}c}{\color{y}\scriptsize\textit{Tech. A.-V. Bastien Vandendaele}}\\
\multirow{1}{*}{13:30} & 
...
\noindent\begin{tabular}{m{1cm}m{3.5cm}m{14.36cm}}
\rowcolor{cefd}
...
01 &	\textbf{Annie Claude Bélisle} &	Modélisation des impacts des changements environnementaux sur les paysages autochtones à partir des savoirs locaux et scientifiques\\
02 &	\textbf{Batistin Bour} &	Apport du LiDAR dans l’évaluation de la croissance de la forêt boréale après perturbation majeure.\\
03 &	\textbf{Valentina Buttò} &	Production et période de formation du xylème de l’épinette noire le long d’un gradient latitudinal au Québec\\
04 &	\raggedright\textbf{Thais Campos de Oliveira} &	Rôle des transporteurs d'ammonium dans la fitness des champignons responsables de la Maladie Hollandaise de l'Orme\\
05 &	\textbf{Jérôme Chapuis} &	Génomique fonctionnelle de la virulence et la fitness chez Ophiostoma novo-ulmi\\
06 &	\textbf{Delphine De Pierre} &	Détermination des effets de la tique d'hiver \textit{Dermacentor albipictus} sur la santé des orignaux : une approche expérimentale\\
07 &	\textbf{Emilie Drolet} &	Délimitation des zones de contraintes de drainage aux opérations forestières : comparaison entre deux versions du \textit{Topographic Wetness Index}\\
08 &	\textbf{Marine Duperat} &	Impacts du climat boréal et des éclaircies sur la réaction du Sapin Baumier \textit{Abies balsamea} face aux charges imposées par le vent\\
09 &	\textbf{Flavie Ferrer} &	Connaître la densité du bois, une aiguille dans une botte de cernes\\
10 &	\textbf{Carla Francisco} &	Modelling the impact of environmental stochasticity in woodland caribou populations\\
11 &	\textbf{Karelle Gilbert} &	Effets de différents modes de gestion des chemins à faible fréquentation sur l'habitat aquatique\\
12 &	\textbf{David Grenier-Héon} &	Analyse des patrons de mortalité des arbres de la forêt boréale du québec dans le contexte des changements climatiques et du bilan de carbone\\
13 &	\textbf{Mathieu Landry} &	Taxonomic and functional variations of spruce budworm bacterial communities over time and space\\
14 &	\textbf{Christopher Madsen} &	How neighbourhood interactions between 6 tropical tree species affect the horizontal extent of their root systems\\
15 &	\textbf{Annie Montpetit} &	Vers une opérationnalisation de l’évaluation de la capacité d’adaptation des communautés humaines aux changements climatiques : l’exemple des communautés canadiennes dépendantes de la forêt\\
16 &	\textbf{Jeffrey Opoku-Nyame} &	Twelve-year impacts of partial and clear cut on epixylic bryophyte species in boreal black spruce –feathermoss forests\\
17 &	\textbf{Alexandre Pace} &	Des reconstitutions climatiques avec le cèdre blanc \textit{Thuya occidentalis} dans les montagnes Chic-chocs et McGerrigle, Parc national de la Gaspésie\\
18 &	\textbf{Charlotte Smetanka} &	Évaluation de la sévérité des feux dans la forêt boréale québécoise par une approche multi-échelle\\
19 &	\textbf{Emy Tremblay} &	Les épidémies de la tordeuse des bourgeons de l’épinette dans les sédiments lacustres\\
20 &	\textbf{Bastien Vandendaele} &	Assessing the capacity of UAV-based LiDAR to support forest inventory in different forest environments\\
NM/NE* &	\textbf{Audrey Lemay} &	Comparison of wood density in roots and stems of black spruce before and after commercial thinning\\
NM/NE &	\textbf{Clément Chion} &	Démarche participative et jeux sérieux en support à l’adaptation de l'aménagement forestier multi-usage aux changements globaux\\
NM/NE &	\textbf{Emilie Champagne} &	Étude de la résistance au broutement de plants forestiers dans un contexte de migration assistée en forêt mixte tempérée\\
NM/NE &	\textbf{Jean-Daniel Sylvain} &	Quantifier l'effet des changements globaux sur la diversité des communautés biologiques\\
NM/NE &	\textbf{Julien Beguin} &	Predicting soil properties in the Canadian boreal forest with limited data: Comparison of spatial and non-spatial statistical approaches\\
NM/NE &	\textbf{Lahcen Benomar} &	La migration assistée comme mesure proactive d’adaptation aux changements climatiques : cas de l’épinette blanche au Québec\\
NM/NE &	\textbf{Martin Barrette} &	Évaluer les écarts entre la forêt aménagée et la forêt naturelle avec la naturalité pour soutenir l’aménagement écosystémique\\
NM/NE &	\textbf{Mathieu Carpentier} &	Identification d'arbres à partir d'images de l'écorce\\
NM/NE &	\textbf{Nelson Thiffault} &	Managing plantation density through initial spacing and commercial thinning: Growth and yield results from a 60-year-old red pine experiment\\
NM/NE &	\textbf{Patricia Raymond} &	Options sylvicoles pour régénérer et conserver la structure irrégulière des sapinières à bouleau jaune\\
NM/NE &	\textbf{Rim Khlifa} &	Effets de l’augmentation de la température du sol et des dépôts d’azote sur la structure et la diversité des communautés bactériennes de la phyllosphère chez l’épinette noire\\
NM/NE &	\raggedright\textbf{Steve Roussel Kentsa Kouom} &	Cartographie participative des services écosystémiques des paysages autochtones\\
NM/NE &	\textbf{Tanya Handa} &	Canadian Repository of Invertebrate Traits and Trait-like Ecological Records – Traits des invertébrés du Canada (CRITTER)\\
NM/NE &	\textbf{Victor Danneyrolles} &	Utilisation des archives d’arpentage pour affiner les cibles de composition pour l’aménagement écosystémique des forêts tempérées du Québec\\
...
Bottom-up simulation of forest disturbances using NetLogo\newline\newline\hspace*{\fill} \hfill  \textbf{Liliana Perez} et \textbf{Saeed Harati}\\
...
SpaDES, not “just another model” Part 2: Getting started with SpaDES in R\newline\hspace*{\fill} \hfill  \textbf{Mario van Telgen} et \textbf{Ceres Barros}\\
\arrayrulecolor{cefd}\hline
